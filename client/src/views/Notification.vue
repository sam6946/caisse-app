              ...
              <v-row>
                <v-col cols="12" sm="6" class="blue rounded-br-x1">
                  <div style="text-align: center; padding:180px 0;">
                    <v-card-text class="white--text">
                      <h1 class="text-center">Notification Service</h1>
                      <h3 class="text-center">
                         Your allow the app to send you message via <br>
                         your Eamil
                      </h3> 
                    </v-card-text>
                  </div>
                ...
                <v-col cols="12" sm="6">
                  <v-card-text class="mt-12">
                    <h4 class="text-center">Configure a ton temps</h4>
                    <h6 class="text-center grey--text">
                      Entrer l'heure a laquelle tu veux etre notifier
                    </h6>
                    <v-row align="center" justify="center">
                      <v-col cols="12" sm="8">
